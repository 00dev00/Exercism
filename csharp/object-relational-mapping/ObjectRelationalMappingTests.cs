...
public class ObjectRelationalMappingTests
{
    ...
    public void Write_good()
    {
        ...
        Assert.Equal([Database.State.DataWritten, "good write"], actual);
    }
    ...
    public void Write_bad()
    {
        ...
        orm.Write("bad write");
        object[] actual = [db.DbState, db.lastData];
        Assert.Equal([Database.State.Closed, "bad write"], actual);
    }
    ...
    public void Commit_good()
    {
        ...
        orm.Commit();
        object[] actual = [db.DbState, db.lastData];
        Assert.Equal([Database.State.Closed, "good commit"], actual);
    }
    ...
    public void Commit_bad()
    {
        ...
        orm.Commit();
        object[] actual = [db.DbState, db.lastData];
        Assert.Equal([Database.State.Closed, "bad commit"], actual);
    }
    ...
    public void Out_of_order()
    {
        ...
        orm.Commit();
        object[] actual = [db.DbState, db.lastData];
        Assert.Equal([Database.State.Closed, string.Empty], actual);
    }
    ...
    public void Disposable()
    {
        ...
        disposable.Dispose();
        object[] actual = [db.DbState, db.lastData];
        Assert.Equal([Database.State.Closed, "good data"], actual);
    }
}
