...
public class HyperOptimizedTelemetryTests
{
    ...
    public void ToBuffer_upper_long()
    {
        ...
        Assert.Equal([0xf8, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x7f], bytes);
    }
    ...
    public void ToBuffer_lower_long()
    {
        ...
        Assert.Equal([0xf8, 0x0, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0], bytes);
    }
    ...
    public void ToBuffer_upper_uint()
    {
        ...
        Assert.Equal([0x4, 0xff, 0xff, 0xff, 0xff, 0x0, 0x0, 0x0, 0x0], bytes);
    }
    ...
    public void ToBuffer_lower_uint()
    {
        ...
        Assert.Equal([0x4, 0x0, 0x0, 0x0, 0x80, 0x0, 0x0, 0x0, 0x0], bytes);
    }
    ...
    public void ToBuffer_upper_int()
    {
        ...
        Assert.Equal([0xfc, 0xff, 0xff, 0xff, 0x7f, 0x0, 0x0, 0x0, 0x0], bytes);
    }
    ...
    public void ToBuffer_lower_int()
    {
        ...
        Assert.Equal([0xfc, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0], bytes);
    }
    ...
    public void ToBuffer_upper_ushort()
    {
        ...
        Assert.Equal([0x2, 0xff, 0xff, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0], bytes);
    }
    ...
    public void ToBuffer_lower_ushort()
    {
        ...
        Assert.Equal([0x2, 0x0, 0x80, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0], bytes);
    }
    ...
    public void ToBuffer_upper_short()
    {
        ...
        Assert.Equal([0x2, 0xff, 0x7f, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0], bytes);
    }
    ...
    public void ToBuffer_Zero()
    {
        ...
        Assert.Equal([0x2, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0], bytes);
    }
    ...
    public void ToBuffer_upper_neg_short()
    {
        ...
        Assert.Equal([0xfe, 0xff, 0xff, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0], bytes);
    }
    ...
    public void ToBuffer_lower_neg_short()
    {
        ...
        Assert.Equal([0xfe, 0x0, 0x80, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0], bytes);
    }
    ...
    {
        int n = short.MinValue - 1;
        var bytes = TelemetryBuffer.ToBuffer(n);
        Assert.Equal([0xfc, 0xff, 0x7f, 0xff, 0xff, 0x0, 0x0, 0x0, 0x0], bytes);
    }
    ...
    public void ToBuffer_lower_neg_int()
    {
        ...
        Assert.Equal([0xfc, 0x0, 0x0, 0x0, 0x80, 0x0, 0x0, 0x0, 0x0], bytes);
    }
    ...
    public void ToBuffer_upper_neg_long()
    {
        ...
        Assert.Equal([0xf8, 0xff, 0xff, 0xff, 0x7f, 0xff, 0xff, 0xff, 0xff], bytes);
    }
    ...
    public void ToBuffer_lower_neg_long()
    {
        ...
        Assert.Equal([0xf8, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x80], bytes);
    }
    ...
    {
        Assert.Equal(0,
            TelemetryBuffer.FromBuffer([22, 0xff, 0xff, 0xff, 0x7f, 0, 0, 0, 0]));
    }
    ...
    public void FromBuffer_upper_long()
    {
        Assert.Equal(long.MaxValue,
            TelemetryBuffer.FromBuffer([0xf8, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x7f]));
    }
    ...
    public void FromBuffer_lower_long()
    {
        Assert.Equal((long)uint.MaxValue + 1,
            TelemetryBuffer.FromBuffer([0xf8, 0x0, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0]));
    }
    ...
    public void FromBuffer_upper_uint()
    {
        Assert.Equal(uint.MaxValue,
            TelemetryBuffer.FromBuffer([0x4, 0xff, 0xff, 0xff, 0xff, 0x0, 0x0, 0x0, 0x0]));
    }
    ...
    public void FromBuffer_lower_uint()
    {
        Assert.Equal((long)int.MaxValue + 1,
            TelemetryBuffer.FromBuffer([0x4, 0x0, 0x0, 0x0, 0x80, 0x0, 0x0, 0x0, 0x0]));
    }
    ...
    public void FromBuffer_upper_int()
    {
        Assert.Equal(int.MaxValue,
            TelemetryBuffer.FromBuffer([0xfc, 0xff, 0xff, 0xff, 0x7f, 0x0, 0x0, 0x0, 0x0]));
    }
    ...
    public void FromBuffer_lower_int()
    {
        Assert.Equal(ushort.MaxValue + 1,
            TelemetryBuffer.FromBuffer([0xfc, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0]));
    }
    ...
    public void FromBuffer_upper_ushort()
    {
        Assert.Equal(ushort.MaxValue,
            TelemetryBuffer.FromBuffer([0x2, 0xff, 0xff, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0]));
    }
    ...
    public void FromBuffer_lower_ushort()
    {
        Assert.Equal(short.MaxValue + 1,
            TelemetryBuffer.FromBuffer([0x2, 0x0, 0x80, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0]));
    }
    ...
    public void FromBuffer_upper_short()
    {
        Assert.Equal(short.MaxValue,
            TelemetryBuffer.FromBuffer([0xfe, 0xff, 0x7f, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0]));
    }
    ...
    {
        Assert.Equal(0,
            TelemetryBuffer.FromBuffer([0xfe, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0]));
    }
    ...
    {
        Assert.Equal(-1,
            TelemetryBuffer.FromBuffer([0xfe, 0xff, 0xff, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0]));
    }
    ...
    public void FromBuffer_lower_neg_short()
    {
        Assert.Equal(short.MinValue,
            TelemetryBuffer.FromBuffer([0xfe, 0x0, 0x80, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0]));
    }
    ...
    public void FromBuffer_upper_neg_int()
    {
        Assert.Equal(short.MinValue - 1,
            TelemetryBuffer.FromBuffer([0xfc, 0xff, 0x7f, 0xff, 0xff, 0x0, 0x0, 0x0, 0x0]));
    }
    ...
    public void FromBuffer_lower_neg_int()
    {
        Assert.Equal(int.MinValue,
            TelemetryBuffer.FromBuffer([0xfc, 0x0, 0x0, 0x0, 0x80, 0x0, 0x0, 0x0, 0x0]));
    }
    ...
    public void FromBuffer_upper_neg_long()
    {
        Assert.Equal((long)int.MinValue - 1,
            TelemetryBuffer.FromBuffer([0xf8, 0xff, 0xff, 0xff, 0x7f, 0xff, 0xff, 0xff, 0xff]));
    }
    ...
    public void FromBuffer_lower_neg_long()
    {
        Assert.Equal(long.MinValue,
            TelemetryBuffer.FromBuffer([0xf8, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x80]));
    }
}