...
public class StrainTests
{
    ...
    {
        Assert.Equal([1, 3], new[] { 1, 2, 3 }.Keep(x => x % 2 != 0));
    }
    ...
    public void Keep_arrays()
    {
        ...
        var expected = new[] { new[] { 5, 5, 5 }, [5, 1, 2], [1, 5, 2], [1, 2, 5] };
    ...
    {
        Assert.Equal([2], new[] { 1, 2, 3 }.Discard(x => x % 2 != 0));
    }
    ...
    public void Discard_arrays()
    {
        ...
        var expected = new[] { new[] { 1, 2, 3 }, [2, 1, 2], [2, 2, 1] };
