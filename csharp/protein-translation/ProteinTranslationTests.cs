...
public class ProteinTranslationTests
{
    ...
    {
        Assert.Equal(["Methionine"], ProteinTranslation.Proteins("AUG"));
    }

    [Fact]
    public void Phenylalanine_rna_sequence_1()
    {
        Assert.Equal(["Phenylalanine"], ProteinTranslation.Proteins("UUU"));
    }

    [Fact]
    public void Phenylalanine_rna_sequence_2()
    {
        Assert.Equal(["Phenylalanine"], ProteinTranslation.Proteins("UUC"));
    }

    [Fact]
    public void Leucine_rna_sequence_1()
    {
        Assert.Equal(["Leucine"], ProteinTranslation.Proteins("UUA"));
    }

    [Fact]
    public void Leucine_rna_sequence_2()
    {
        Assert.Equal(["Leucine"], ProteinTranslation.Proteins("UUG"));
    }

    [Fact]
    public void Serine_rna_sequence_1()
    {
        Assert.Equal(["Serine"], ProteinTranslation.Proteins("UCU"));
    }

    [Fact]
    public void Serine_rna_sequence_2()
    {
        Assert.Equal(["Serine"], ProteinTranslation.Proteins("UCC"));
    }

    [Fact]
    public void Serine_rna_sequence_3()
    {
        Assert.Equal(["Serine"], ProteinTranslation.Proteins("UCA"));
    }

    [Fact]
    public void Serine_rna_sequence_4()
    {
        Assert.Equal(["Serine"], ProteinTranslation.Proteins("UCG"));
    }

    [Fact]
    public void Tyrosine_rna_sequence_1()
    {
        Assert.Equal(["Tyrosine"], ProteinTranslation.Proteins("UAU"));
    }

    [Fact]
    public void Tyrosine_rna_sequence_2()
    {
        Assert.Equal(["Tyrosine"], ProteinTranslation.Proteins("UAC"));
    }

    [Fact]
    public void Cysteine_rna_sequence_1()
    {
        Assert.Equal(["Cysteine"], ProteinTranslation.Proteins("UGU"));
    }

    [Fact]
    public void Cysteine_rna_sequence_2()
    {
        Assert.Equal(["Cysteine"], ProteinTranslation.Proteins("UGC"));
    }

    [Fact]
    public void Tryptophan_rna_sequence()
    {
        Assert.Equal(["Tryptophan"], ProteinTranslation.Proteins("UGG"));
    }
    ...
    {
        Assert.Equal(["Phenylalanine", "Phenylalanine"], ProteinTranslation.Proteins("UUUUUU"));
    }

    [Fact]
    public void Sequence_of_two_different_protein_codons_translates_into_proteins()
    {
        Assert.Equal(["Leucine", "Leucine"], ProteinTranslation.Proteins("UUAUUG"));
    }

    [Fact]
    public void Translate_rna_strand_into_correct_protein_list()
    {
        Assert.Equal(["Methionine", "Phenylalanine", "Tryptophan"], ProteinTranslation.Proteins("AUGUUUUGG"));
    }
    ...
    {
        Assert.Equal(["Tryptophan"], ProteinTranslation.Proteins("UGGUAG"));
    }

    [Fact]
    public void Translation_stops_if_stop_codon_at_end_of_three_codon_sequence()
    {
        Assert.Equal(["Methionine", "Phenylalanine"], ProteinTranslation.Proteins("AUGUUUUAA"));
    }

    [Fact]
    public void Translation_stops_if_stop_codon_in_middle_of_three_codon_sequence()
    {
        Assert.Equal(["Tryptophan"], ProteinTranslation.Proteins("UGGUAGUGG"));
    }

    [Fact]
    public void Translation_stops_if_stop_codon_in_middle_of_six_codon_sequence()
    {
        Assert.Equal(["Tryptophan", "Cysteine", "Tyrosine"], ProteinTranslation.Proteins("UGGUGUUAUUAAUGGUUU"));
    }
}
